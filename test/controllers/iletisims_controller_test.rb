...
class IletisimsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create iletisim" do
    assert_difference('Iletisim.count') do
      post iletisims_url, params: { iletisim: { ad: @iletisim.ad, email: @iletisim.email, mesaj: @iletisim.mesaj, soyad: @iletisim.soyad } }
    end
  ...
  test "should update iletisim" do
    patch iletisim_url(@iletisim), params: { iletisim: { ad: @iletisim.ad, email: @iletisim.email, mesaj: @iletisim.mesaj, soyad: @iletisim.soyad } }
