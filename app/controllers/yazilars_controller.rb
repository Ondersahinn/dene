class YazilarsController < ApplicationController
  ...
  def show
    @comment = Comment.new
    @comments = @yazilar.comments.order("created_at DESC")
  end

  # GET /yazilarsp' in any of the gem sources listed in your Gemfile.
  ...
  private
    ...
    def yazilar_params
      params.require(:yazilar).permit(:kategori, :baslik,:resim, :yazar, :aciklama, :tarih)
    end
end
